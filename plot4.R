...
par(mfrow=c(2,2))
plot(tt,ll[,"Global_active_power"],xlab="",ylab="energy sub-metering",type='l')
plot(tt,ll[,"Voltage"],xlab="datetime",ylab="Voltage",type='l')
...
pch=c('！！','！！','！！'))
plot(tt,ll[,"Global_reactive_power"],xlab="datetime",ylab="Global_reactive_power",type='l')
dev.off()
